...
from wesep2.utils.datadir_writer import DatadirWriter
from wesep2.utils.file_utils import SoundScpReader
from wesep2.utils.score import cal_SISNR
from wesep2.utils.utils import ArgumentParser, get_commandline_args, str2bool
...
def scoring(
    ...
    if use_dnsmos:
        if dnsmos_args["mode"] == "local":
            from wesep2.utils.dnsmos import DNSMOS_local
            ...
            from wesep2.utils.dnsmos import DNSMOS_web
